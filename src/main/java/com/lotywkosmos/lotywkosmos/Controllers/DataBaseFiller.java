    ...
    public String createRandomPortLinks(){
        for(int i=1; i<31; i++){
            portLinkService.addPortLinkToBase(PortLink.builder()
                    .StartingPort(portService.getSinglePort(1 + random.nextInt(15)))
                    .EndPort(portService.getSinglePort(16 + random.nextInt(15)))
                    .build());
        }
        return "added 30 new Port Links";
    }
    ...
    public String createRandomFlights(){
        for(int i=2021; i<2051; i++){
            flightService.addFlightToBase(Flight.builder()
                    ...
                    .portLink(portLinkService.getSinglePort(1 + random.nextInt(30)))
                    .ticketPrice((double) (10000 + random.nextInt(154354)))
                    .build());
        }
        return "added 30 new flights";
    }
